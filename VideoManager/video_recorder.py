...
class VideoRecorder(VideoRecorderInterface):
    def __init__(self, record_path):
        ...
        self.__fourcc_writer = cv2.VideoWriter_fourcc('X', 'V', 'I', 'D')
    ...
    def __init_writer(self):
        ...
        self.__video_writer = cv2.VideoWriter(self.__recording_path + self.__current_vid_file, self.__fourcc_writer, 30.0, (640, 480))
